mad <- MDFS::madelon
n <- 2000
mad_sample_X <- mad$data[1:n, 471:500]
...
MDFS::ComputeMaxInfoGains(mad_sample_X, mad_sample_Y, dimensions=2, divisions = 1, range=0, pseudo.count=0.25, seed=123)

mad <- MDFS::madelon
result = MDFS::ComputeMaxInfoGains(mad_sample_X, mad_sample_Y, dimensions=3, divisions = 1, range=0, pseudo.count=0.25, seed=123)
order(-result$IG)
result[order(-result$IG),]
