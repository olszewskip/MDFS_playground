...
MDFS::ComputeMaxInfoGains(mad_sample_X, mad_sample_Y, dimensions=2, divisions = 1, range=0, pseudo.count=1e-5, seed=123)

my_df = read.csv("my_df_1.csv", header=FALSE)
MDFS::ComputeMaxInfoGains(my_df[,1:2], my_df[,3], dimensions=2, divisions = 1, range=0, pseudo.count=1e-5, seed=123)
