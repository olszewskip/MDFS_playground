...
std::tuple<double, double> work_2(const int kData_dim,
    ...
    //#pragma omp parallel for reduction (+: neg_H_y, neg_H_X0_y, neg_H_X1_y)
    for (int C_Xidx_i = 0; C_Xidx_i < kC_Xdim; C_Xidx_i++) {
        double count_X0_y = 0;
        double count_X1_y = 0;        
        for (int C_Xidx_j = 0; C_Xidx_j < kC_Xdim; C_Xidx_j++) {
            neg_H_y += contingency_m_y[C_Xidx_i][C_Xidx_j] * log2(contingency_m_y[C_Xidx_i][C_Xidx_j]);
            count_X0_y += contingency_m_y[C_Xidx_j][C_Xidx_i];
            count_X1_y += contingency_m_y[C_Xidx_i][C_Xidx_j];
        }
        neg_H_X0_y += count_X0_y * log2(count_X0_y);
        neg_H_X1_y += count_X1_y * log2(count_X1_y);
    }
    
    return {neg_H - neg_H_y - neg_H_X0 + neg_H_X0_y,
            neg_H - neg_H_y - neg_H_X1 + neg_H_X1_y
           };
}
...
std::tuple<double, double, double> work_3(const int kData_dim,
    ...
    double neg_H_y=0., neg_H_X0_y=0., neg_H_X1_y=0., neg_H_X2_y = 0.;
    ...
    //#pragma omp parallel for reduction (+: neg_H_y, neg_H_X0_y, neg_H_X1_y, neg_H_X2_y)
    for (int C_Xidx_i = 0; C_Xidx_i < kC_Xdim; C_Xidx_i++) {
        for (int C_Xidx_j = 0; C_Xidx_j < kC_Xdim; C_Xidx_j++) {
            double count_X0_y = 0;
            double count_X1_y = 0;
            double count_X2_y = 0;
            for (int C_Xidx_k = 0; C_Xidx_k < kC_Xdim; C_Xidx_k++) {
                neg_H_y += contingency_m_y[C_Xidx_i][C_Xidx_j][C_Xidx_k] * log2(contingency_m_y[C_Xidx_i][C_Xidx_j][C_Xidx_k]);
            ...
            neg_H_X0_y += count_X0_y * log2(count_X0_y);
            neg_H_X1_y += count_X1_y * log2(count_X1_y);
            neg_H_X2_y += count_X2_y * log2(count_X2_y);
        }
    }
    
    return {neg_H - neg_H_y - neg_H_X0 + neg_H_X0_y,
            neg_H - neg_H_y - neg_H_X1 + neg_H_X1_y,
            neg_H - neg_H_y - neg_H_X2 + neg_H_X2_y
           };
}
