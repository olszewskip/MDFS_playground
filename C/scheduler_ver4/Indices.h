...
class Indices_sum : public Indices {
   ...
   public:
      ...
      void use_buff(int* const buff) {
         index = buff;
         ind_L.use_buff(buff);
         // in case ind_L is the summation identity
...
Indices_sum& build_cpu_tile_scheduler(int R[]) {
   static std::vector<Indices_triangle> signif_fat_3;
   static std::vector<Indices_triangle> signif_lean_3;
   static std::vector<Indices_product> signif_fat_x_lean_3;
   static std::vector<Indices_sum> signif_fat_x_lean_3_sum;
   static Indices_sum_id zero_3(kDim);
   static Indices_sum& heterogen_signif_3 = fold(signif_fat_3,
                                                 signif_lean_3,
                                                 signif_fat_x_lean_3,
                                                 ...
                                                 kDim);
   //
   static std::vector<Indices_triangle> signif_fat_4;
   static std::vector<Indices_triangle> signif_lean_4;
   static std::vector<Indices_product> signif_fat_x_lean_4;
   static std::vector<Indices_sum> signif_fat_x_lean_4_sum;
   static Indices_sum_id zero_4(kDim - 1);
   static Indices_sum& heterogen_signif_4 = fold(signif_fat_4,
                                                 signif_lean_4,
                                                 signif_fat_x_lean_4,
                                                 ...
                                                 1,
                                                 kDim - 1);
   static Indices_triangle nonsignif_and_contrast_4(1, R[6], R[2], true);
   static Indices_product heterogen_mixed_4(heterogen_signif_4, nonsignif_and_contrast_4);
   //
   static Indices_triangle signif_fat_5(kDim - 1, R[1], R[0], true);
   static Indices_triangle nonsignif_lean_5(1, R[4], R[3], true);
   static Indices_triangle contrast_lean_5(1, R[6], R[5], true);
   static Indices_sum nonsignif_plus_contrast_lean_5(nonsignif_lean_5, contrast_lean_5);
   static Indices_product heterogen_mixed_5(signif_fat_5, nonsignif_plus_contrast_lean_5);
   //
   static Indices_sum heterogen_sum_1(heterogen_signif_3, heterogen_mixed_4);
   static Indices_sum cpu_tile_scheduler(heterogen_sum_1, heterogen_mixed_5);
   return cpu_tile_scheduler;
}

Indices_sum& build_gpu_tile_scheduler(int R[]) {
   static Indices_triangle signif_fat_1(kDim, R[1], R[0], true);
   static Indices_triangle signif_fat_2(kDim - 1, R[1], R[0], true);
   static Indices_triangle nonsignif_fat_2(1, R[3], R[2], true);
   static Indices_triangle contrast_fat_2(1, R[5], R[4], true);
   static Indices_sum nonsignif_plus_contrast_fat_2(nonsignif_fat_2, contrast_fat_2);
   static Indices_product fat_2(signif_fat_2, nonsignif_plus_contrast_fat_2);
   static Indices_sum gpu_tile_scheduler(signif_fat_1, fat_2);
   return gpu_tile_scheduler;
}
